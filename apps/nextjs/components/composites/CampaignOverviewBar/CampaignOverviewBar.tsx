    ...
    <BackgroundContent pt="4" pb={{ base: "20", md: "8" }} {...containerProps}>
      <Container>
        ...
        <Stack direction={{ base: "column", md: "row" }} spacing={{ base: 0, md: 6, lg: 10 }}>
          ...
          <Box flex="1">
            {initWistia && (
              <Box className="wistia_responsive_padding" position="relative" padding="56.25% 0 0 0">
                <Box
                  className="wistia_responsive_wrapper"
                  height="100%"
                  left="0"
            ...
            <Text color="gray.500" py="2" fontSize="xs">
              Lewis explains why The Somerville Homeless Coalition is so awesome and why we're
              pigpiling on them.
            </Text>
          </Box>
        </Stack>
