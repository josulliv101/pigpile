  ...
  return (
    <>
      <Center w="80%" textAlign="center" color="white" top={{ base: "38%", sm: "36%" }}>
        <Heading size="lg" fontSize={{ base: "1.2rem", sm: "1.6rem" }} fontWeight="500" mb="3">
          Pigpile on good causes.
        </Heading>
        <Heading size={{ base: "sm", sm: "md" }} fontWeight="normal" mb="6">
          an online fund-raising platform
        </Heading>
        <Text opacity=".9" maxW="max" px="10px" mx="auto" mb="12" fontSize={{ base: ".9rem", sm: "1.1rem" }} pt="4" borderTop="1px" borderColor="whiteAlpha.700">
        ...
        <NextLink href="/long" passHref>
          ...
          <Button width="full" maxWidth="max-content" boxShadow="md" size={{ base: "md", md: "lg" }} fontWeight="semibold" variant="solid">
            View Pigpiles
          </Button>
        </NextLink>
      </Center>
