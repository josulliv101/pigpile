...
export const frLabelBundle: LabelBundleType = {
  // org
  org: "Pigpile ❤️",
  orgFormal: "Pigpile Corporation ❤️",
  tagline: "Pigpile on good causes ❤️",
  mission:
    "Our mission is to inspire giving and help good causes raise funds/in-kind donations ❤️",
  platform: "an online fund-raising platform ❤️",

  // legal
  copyright: "All rights reserved ❤️",
