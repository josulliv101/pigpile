...
export interface CardProps extends HTMLChakraProps<"div">, ThemingProps<"Card"> {}
...
export const CardAvatar = forwardRef<CardAvatarProps, typeof Avatar>((props, ref) => {
  const styles = useStyles();
  return (
    <Box
      ref={ref}
...
export const CardBackground = forwardRef<CardBackgroundProps, "div">((props, ref) => {
  const styles = useStyles();
  return (
    <Box
      ref={ref}
